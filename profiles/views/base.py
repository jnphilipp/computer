...
@csrf_protect
@piwik('Sign in • Profile • computer')
def signin(request):
...
@csrf_protect
@piwik('Sign up • Profile • computer')
def signup(request):
    if request.method == 'POST':
...
@csrf_protect
@piwik('Sign out • Profile • computer')
def signout(request):
    return views.logout(request, template_name='registration/signout.html')


@csrf_protect
@piwik('Password change • Profile • computer')
...
@csrf_protect
@piwik('Password reset • Profile • computer')
